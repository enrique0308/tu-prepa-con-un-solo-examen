// Script para manejar el formulario de contacto y funcionalidades de la página
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupTestimoniosSlider() {
        ...
        const totalSlides = document.querySelectorAll('.testimonio.video-card').length;
        let currentSlide = 0;
        
        // Mostrar solo 2 testimonios a la vez
        const updateSlider = () => {
            const offset = -(currentSlide * 50); // 50% por slide
